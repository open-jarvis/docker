...
# install data
apt update
apt install -y python3 python3-pip python3-paho-mqtt git wget wajig
...
mkdir /jarvis/autoupdate
cd /jarvis/autoupdate
git clone https://github.com/open-jarvis/autoupdate .

# create starter file
echo "/usr/bin/python3 /jarvis/autoupdate/updater.py" > /starter 
chmod a+x /starter


# remove data
apt purge -y python3-pip wget wajig
apt clean
apt autoremove -y
```